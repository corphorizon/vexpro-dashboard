-- ─────────────────────────────────────────────────────────────────────────────
-- Migración 102 (renumerada dos veces: la 100 la tomó crm_monthly_totals y la 101 el diagnóstico operativo, en merges paralelos) — Asistente de IA (chat privado por usuario) + credencial
